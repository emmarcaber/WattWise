...
class boying(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        sub = ttk.Combobox(status_frm, value=['ESAS', 'ENGINEERING', 'MATHEMATICS'])
        sub.current(0)
        ...
        sub = ttk.Combobox(status_frm, value=['Category 1', 'Category 2', 'Category 3'])
        sub.current(0)
        ...
        self.setvar('num_students1', '#') # Di ko na alam kung paano i-count yung number of students hehehehe
        ...
        self.setvar('num_students2', '#') # Di ko na alam kung paano i-count yung number of students hehehehe
        ...
        self.setvar('num_students3', '#') # Di ko na alam kung paano i-count yung number of students hehehehe
        ...
        self.setvar('num_students4', '#') # Di ko na alam kung paano i-count yung number of students hehehehe
        ...
        self.setvar('num_students5', '#') # Di ko na alam kung paano i-count yung number of students hehehehe
        ...
        self.setvar('num_students', '#') # Di ko na alam kung paano i-count yung number of students hehehehe
        ...
        tv.configure(columns=( 'Name', 'ID Number', 'Date of Examination', 'Set'))
        ...
        my_label = ttk.Label(tab1, text="This is SET A", font=("Helvetica", 18))
        my_label.pack(pady=20)

        my_label2 = ttk.Label(tab2, text="This is SET B", font=("Helvetica", 18))
        my_label2.pack(pady=20)
        
        my_label3 = ttk.Label(tab3, text="This is SET C", font=("Helvetica", 18))
        my_label3.pack(pady=20)

        my_label4 = ttk.Label(tab4, text="This is SET D", font=("Helvetica", 18))
        my_label4.pack(pady=20)

        my_label5 = ttk.Label(tab5, text="This is SET E", font=("Helvetica", 18))
        ...
        for x in range(1, 35):
            ...
            tv.insert('', END, x, values=(f'Student {x}', f'C2010063{x}', timestamp, set1))
        tv.selection_set(1)
